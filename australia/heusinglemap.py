...
class Map():
    ...
    ## degree constraint heuristic- selects the state with most constraining value
        ...
        for v in range(self.V):
            ...
            if temp > Max_degree_constarint:

                Max_degree_constarint = temp
    ...
    def Sigleton_remove_domain_variables(self, v):
    ...
    def Singleton_logic(self, Singleton_states_list):

        if len(Singleton_states_list)==0:
